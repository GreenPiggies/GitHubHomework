...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(800, 800, OPENGL);  // Set up the Applet window to be 800x600
		...
		map1 = new UnfoldingMap(this, 0, 0, 200, 200, provider);
		...
		map2 = new UnfoldingMap(this, 250, 0, 200, 200, provider);
