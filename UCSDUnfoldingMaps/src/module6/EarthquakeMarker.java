...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	{
		if (Double.parseDouble(this.getProperty("magnitude").toString()) < Double.parseDouble(marker.getProperty("magnitude").toString()))
		{
			return 1;
		} else if (Double.parseDouble(this.getProperty("magnitude").toString()) == Double.parseDouble(marker.getProperty("magnitude").toString()))
		{
			return 0;
		} else
		{
