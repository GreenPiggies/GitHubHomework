...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String holder = getStringFromFile(textfile, numToCheck);
			
			num = System.nanoTime();
			for (int i = 0; i < trials; i++)
			{
				BasicDocument basic = new BasicDocument(holder);
				basic.getFleschScore();
			}
			num = System.nanoTime() - num;
			System.out.print(num + "\t");
			
			num = System.nanoTime();
			for (int i = 0; i < trials; i++)
			{
				EfficientDocument efficient = new EfficientDocument(holder);
